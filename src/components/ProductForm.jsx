    ...
    <div>
      ...
      >
        ...
        <input
          type="text"
          required
          className="text-gray-800 shadow appearance-none border rounded w-full py-2 px-3"
          autoFocus
          id="name"
          name="name"
          placeholder="name"
        ...
        <input
          type="file"
          className="text-gray-800 shadow appearance-none border rounded w-full py-2 px-3 mb-2"
